...
class Doc {
  ...
  Doc.fromOject(dynamic o) {
    ...
    this.expiration = DateUtils.TrimDate(o["expiration"] as String);

    this.fqYear = o["fqYear"] as int;
    this.fqHalfYear = o["fqHalfYear"] as int;
    this.fqQuarter = o["fqQuarter"] as int;
    this.fqMonth = o["fqMonth"] as int;
  }
}
